...
export default function Home() {
  return (
    <main className="flex flex-col items-center justify-between lg:p-12 p-8">
      <div className="w-full p-6 bg-white/30 rounded-lg text-white space-y-4 > *">
        <h2 className="text-2xl font-bold">Welcome 歡迎</h2>
        <div className=" font-semibold border-b border-gray-300 border-dotted pb-12 lg:w-1/2">
